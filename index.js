import { getCurrentInstance, inject, ref, onMounted, pushScopeId, popScopeId, resolveComponent, openBlock, createBlock, createVNode, toDisplayString, createCommentVNode, withScopeId, createTextVNode } from 'vue';
...
var script$1 = {
    ...
    setup: function (props, _a) {
        ...
        var handleInput = function (valueToMask) {
            var inputEl = document.getElementById("inputEl-" + uid);
            if (valueToMask) {
                var maskOptions = hasMultipleMasks.value
                    ? {
                        mask: props.maskPattern.split(", ").map(function (mask) { return ({
                            mask: mask,
                        }); }),
                    }
                    : {
                ...
                if (!mask.value)
                    mask.value = IMask(inputEl, maskOptions);
        ...
        var validate = function (valueToValidate) {
            switch (props.maskType) {
                ...
                case "custom":
                    if (hasMultipleMasks.value) {
                        var masks = props.maskPattern.split(", ");
                        var lengths = masks.map(function (el) { return el.length; });
                        if (!lengths.includes(valueToValidate === null || valueToValidate === void 0 ? void 0 : valueToValidate.length)) {
                            errorMessage.value = "Insira um valor válido";
                            return false;
                        }
                    }
...
const render$1 = /*#__PURE__*/_withId$1((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return (openBlock(), createBlock("div", _hoisted_1$1, [
    ...
    }, null, 8 /* PROPS */, ["id", "model-value", "onUpdate:modelValue", "disabled"]),
    ($setup.errorMessage)
...
var script = {
    ...
    setup: function (props, _a) {
        var _this = this;
        var emit = _a.emit;
        var initialValues = ref({ maskType: null, maskPattern: null });
        var showCustomMask = ref(false);
        var useFieldsStore = inject("stores").useFieldsStore;
        var maskPatterns = {
            cpf: "000.000.000-00",
        ...
        onMounted(function () {
            var _a;
            if (((_a = props.value) === null || _a === void 0 ? void 0 : _a.maskType) === "custom")
                showCustomMask.value = true;
            if (props.value.maskPattern) {
                initialValues.value = props.value;
            }
        });
        var handleInput = function (editData) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(editData.maskType === "custom")) return [3, 2];
                        showCustomMask.value = true;
                        return [4, emitMask({
                                maskType: "custom",
                                maskPattern: null,
        ...
        var emitMask = function (mask) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, useFieldsStore().updateField(props.collection, props.field, {
                            meta: {
                                options: {
        ...
        var setCustomMask = function (mask) {
            emitMask({
                maskType: "custom",
                maskPattern: mask,
            });
...
const _hoisted_4 = /*#__PURE__*/createVNode("p", null, [
  ...
  /*#__PURE__*/createTextVNode("Ex: (00) 0000-0000, (00) 00000-0000 "),
  /*#__PURE__*/createVNode("br"),
  /*#__PURE__*/createTextVNode("Mais informações em: "),
  /*#__PURE__*/createVNode("a", { href: "https://imask.js.org/guide.html#masked-pattern" }, "iMask Pattern")
], -1 /* HOISTED */);
popScopeId();
...
const render = /*#__PURE__*/_withId((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return (openBlock(), createBlock("div", _hoisted_1, [
    createVNode(_component_v_form, {
      ...
      "onUpdate:modelValue": $setup.handleInput
    }, null, 8 /* PROPS */, ["initialValues", "fields", "model-value", "onUpdate:modelValue"]),
    ($setup.showCustomMask)
      ? (openBlock(), createBlock("div", _hoisted_2, [
          _hoisted_3,
          createVNode(_component_v_input, {
            "model-value": $props.value.maskPattern,
            "onUpdate:modelValue": $setup.setCustomMask,
